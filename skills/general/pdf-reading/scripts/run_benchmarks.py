...
PDF_READING_DIR = SCRIPT_DIR.parent
BENCHMARKS_DIR = PDF_READING_DIR / "benchmarks"
...
def _run_extractor(pdf_path: Path) -> dict[str, Any]:
    cmd = [sys.executable, str(SCRIPT_DIR / "pdf_extract.py"), str(pdf_path), "--extract-tables", "--force"]
